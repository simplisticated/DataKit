...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
Extremely fast in-memory database for iOS with intuitive and powerful internal language.
                   DESC

  s.homepage     = "https://github.com/igormatyushkin014/DataKit"
  s.screenshots  = "https://github.com/igormatyushkin014/DataKit/raw/master/Images/logo-1024-300.png"
  ...
  s.source       = { :git => "https://github.com/igormatyushkin014/DataKit.git", :tag => s.version }
